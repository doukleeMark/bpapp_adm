	...
	<div class="page-content">
		<div class="content">  
			<ul class="breadcrumb">
				...
				<li>
					<a href="#" class="active">Login Report</a>
				</li>
			</ul>
			<div class="page-title"> <i class="icon-custom-left" ></i>
				<h3>Report - <span class="semi-bold">Login</span></h3>
			</div>
			<div class="row">
				<div class="col-xs-12">
							...
							<table class="table table-hover table-condensed" id="listTable">
								<thead>
									<tr>
										...
										<th style="width:5%"><nobr>DEVICE</nobr></th>
										<th style="width:5%"><nobr>OS</nobr></th>
										<th style="width:5%"><nobr>APP</nobr></th>
									...
									<div class="pull-left">
										<div class="btn-group">
											...
											<ul class="dropdown-menu">
												<li><a href="/excel/loginReport_excel.php">Export Excel</a></li>
											</ul>
										</div>
									</div>
...
<script src="/js/report_login.js" type="text/javascript"></script> 
</body>
</html>