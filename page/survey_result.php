	...
	<div class="page-content">
		<div class="content">  
			<ul class="breadcrumb">
				...
				<li>
					<a href="#" class="active">Quick Poll Result</a>
				</li>
			</ul>
			<div class="page-title"> <i class="icon-custom-left" ></i>
				<h3>Quick Poll - <span class="semi-bold">Result</span></h3>
			</div>
			<div class="row">
				<div class="col-xs-12">
							...
							<table class="table table-hover table-condensed" id="listTable">
								<thead>
									<tr>
										...
										<th style="width:5%"><nobr>QUESTION_CNT</nobr></th>
										<th style="width:5%"><nobr>VIEWS</nobr></th>
								...
								<div class="pull-left">
									<div class="btn-group">
										...
										<ul class="dropdown-menu">
											<li><a href="#" class="excelBtn">Export Excel</a></li>
										</ul>
									</div>
								</div>
...
<script src="/js/survey_result.js" type="text/javascript"></script> 
</body>
</html>