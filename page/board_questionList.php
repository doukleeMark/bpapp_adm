	...
	<div class="page-content">
		<div class="content">  
			<ul class="breadcrumb">
				...
				<li>
					<a href="#" class="active">Question List</a>
				</li>
			</ul>
			<div class="page-title"> <i class="icon-custom-left" ></i>
				<h3>Question - <span class="semi-bold">List</span></h3>
			</div>
			<div class="row">
				<div class="col-xs-12">
								...
								<div class="pull-left">
									<div class="btn-group">
										...
										<ul class="dropdown-menu">
											<li><a href="/?page=board_questionInfo">New</a></li>
...
<script src="/js/board_questionList.js" type="text/javascript"></script> 
</body>
</html>