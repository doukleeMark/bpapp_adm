	...
	<div class="page-content">
		<div class="content">  
			<ul class="breadcrumb">
				...
				<li>
					<a href="#" class="active">Log Report</a>
				</li>
			</ul>
			<div class="page-title"> <i class="icon-custom-left" ></i>
				<h3>Report - <span class="semi-bold">Log</span></h3>
			</div>
			<div class="row">
				<div class="col-xs-12">
							...
							<table class="table table-hover table-condensed" id="listTable">
								<thead>
									<tr>
										...
										<th style="width:5%"><nobr>CO.</nobr></th>
										<th style="width:8%"><nobr>IP</nobr></th>
										<th style="width:8%"><nobr>EVENT</nobr></th>
...
<script src="/js/report_log.js" type="text/javascript"></script> 
</body>
</html>