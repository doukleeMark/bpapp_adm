	...
	<div class="page-content">
		<div class="content">  
			...
			<div class="page-title"> <i class="icon-custom-left" ></i>
				<h3>Quiz Bank - <span class="semi-bold">List</span></h3>
			</div>
			<div class="row">
				<div class="col-xs-12">
							...
							<table class="table table-hover table-condensed" id="listTable">
								<thead>
									<tr>
										...
										<th style="width:20%"><nobr>TAG</nobr></th>
										<th style="width:38%"><nobr>QUESTION</nobr></th>
										<th style="width:15%"><nobr>WRITER</nobr></th>
                                    ...
                                    <div class="pull-left">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="/?page=el_quizInfo">New</a></li>
...
<script src="/js/el_quizList.js" type="text/javascript"></script> 
</body>
</html>