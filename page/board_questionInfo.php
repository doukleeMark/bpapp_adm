	...
	<div class="page-content">
		<div class="content">  
			<ul class="breadcrumb">
				...
				<li>
					<a href="#" class="active">Question</a>
				</li>
			</ul>
			<div class="page-title"> <i class="icon-custom-left" ></i>
				<h3>Question - <span class="semi-bold"> <?=$pagetitle?></span></h3>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="grid simple">
						...
						<div class="grid-body no-border">
							<form action="/page/board_questionInfo_proc.php" id="board_questionInfo_form" method="post" enctype="multipart/form-data">
...
<script src="/js/board_questionInfo.js" type="text/javascript"></script>
</body>
</html>