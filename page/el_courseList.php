...
<link href="/css/el_courseList.css" rel="stylesheet" type="text/css"/>
	...
	<div class="page-content">
		<div class="content">  
			...
			<div class="page-title"> <i class="icon-custom-left" ></i>
				<h3>Course - <span class="semi-bold">List</span></h3>
			</div>
			<div class="row">
				<div class="col-xs-12">
							...
							<table class="table table-hover table-condensed" id="listTable">
								<thead>
									<tr>
										...
										<th style="width:33%"><nobr>TITLE</nobr></th>
										<th style="width:15%"><nobr>STATUS</nobr></th>
										<th style="width:15%"><nobr>PROGRESS</nobr></th>
										<th style="width:5%"><nobr>ATTEND</nobr></th>
										<th style="width:10%"><nobr>DATE</nobr></th>
                                    ...
                                    <div class="pull-left">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="/?page=el_courseInfo">New</a></li>
                                                <li><a href="#" class="btn_closed">Close</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
...
<script src="/js/el_courseList.js?v=1901291147" type="text/javascript"></script> 
</body>
</html>