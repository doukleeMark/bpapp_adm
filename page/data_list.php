...
<link href="/css/data_list.css" rel="stylesheet" type="text/css"/>
	...
	<div class="page-content">
		<div class="content">  
			<ul class="breadcrumb">
				...
				<li>
					<a href="#" class="active">Data List</a>
				</li>
			</ul>
			<div class="page-title"> <i class="icon-custom-left" ></i>
				<h3>Data - <span class="semi-bold">List</span></h3>
			</div>
			<div class="row">
				<div class="col-xs-12">
							...
							<table class="table table-hover table-condensed" id="listTable">
								<thead>
									<tr>
										...
										<th style="width:8%"><nobr>FOLDER</nobr></th>
										<th style="width:8%"><nobr>TITLE</nobr></th>
										<th style="width:5%"><nobr>SIZE</nobr></th>
									...
									<div class="pull-left">
										<div class="btn-group">
											...
											<ul class="dropdown-menu">
												<li><a href="/?page=data_info">New</a></li>
