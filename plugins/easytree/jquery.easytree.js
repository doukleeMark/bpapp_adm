    ...
    var EasyTree = function (jQueryContext, options) {
        ...
        function sort(nodes) {
            ...
            nodes = nodes.sort(function (n1, n2) {
                var n1_Order = n1.order;
                var n2_Order = n2.order;
                ...
                if (Number(n1_Order) < Number(n2_Order)) { //sort string ascending
                    return -1 * reverse;
                }
                if (Number(n1_Order) > Number(n2_Order)) {
                    return 1 * reverse;
                }
                if (Number(n1_Order) == Number(n2_Order)) {
        ...
        function getOrderHtml(node) {
            var html = '';
            
            var orderClass = "easytree-order";            

            html += '<span class="' + orderClass + ' hidden">';
